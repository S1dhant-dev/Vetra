            ...
            <Container>
                <div className="flex flex-col items-center justify-center">
                    <h4 className="text-2xl lg:text-4xl font-medium">
                        Trusted by <span className="font-subheading italic">Rising</span> brands
                    </h4>
                </div>
            </Container>

            <Container delay={0.1}>
                <div className="flex flex-wrap items-center justify-center gap-20  pt-16 text-muted-foreground transition-all">
                    <Images.company1 className="h-9 w-auto hover:text-foreground" />
                    ...
                    <Images.company10 className="h-9 w-auto hover:text-foreground" />
                </div>
            </Container>
        </div>
    )
