...
const Hero = () => {
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            ...
            <div className="absolute flex lg:hidden size-40 rounded-full bg-green-500 blur-[10rem] top-0 left-1/2 -translate-x-1/2 -z-10"></div>
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    <Container className="relative hidden lg:block overflow-hidden">
                        <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
                            <span>
                                <span className="spark mask-gradient absolute inset-0 h-[100%] w-[100%] animate-flip overflow-hidden rounded-full [mask:linear-gradient(geen,_transparent_50%)] before:absolute before:aspect-square before:w-[200%] before:rotate-[-90deg] before:animate-rotate before:bg-[conic-gradient(from_0deg,transparent_0_340deg,white_360deg)] before:content-[''] before:[inset:0_auto_auto_50%] before:[translate:-50%_-15%]" />
                            </span>
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                                <span className="px-2 py-[0.5px] h-[18px] tracking-wide flex items-center justify-center rounded-full bg-gradient-to-r from-green-200 to-green-600 text-[9px] font-medium mr-2 text-white">
                                    NEW
                                </span>
                           New Ai features
                            </span>
                    ...
                    <Container delay={0.15}>
                        <h1 className="text-3xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto">
                            Revolutionize your {" "}
                            <span className="">
                                marketing with the {" "}
                            </span>
                             power of AI precision
                        </h1>
                    </Container>
                    <Container delay={0.2}>
                        <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
                        Smarter campaigns. Faster growth. Put your brand on autopilot with AI insights that hit the mark every time.
                        </p>
                    </Container>
                    <Container delay={0.25} className="z-20">
                        <div className="flex items-center justify-center mt-6 gap-x-4">
                            <Link href="#" className="flex items-center gap-2 group">
                            <button className='transition-background inline-flex h-10 items-center justify-center rounded-md border border-gray-100 bg-gradient-to-r from-gray-100 via-[#d7fec7] to-[#b7f364] bg-[length:200%_200%] bg-[0%_0%] px-6 font-medium text-gray-950 duration-500 hover:bg-[100%_200%] focus:outline-none focus:ring-1 focus:ring-green-400 focus:ring-offset-1'>Click Me</button>
                            </Link>
                        </div>
                    </Container>
                    <Container delay={0.3} className="relative">
                        <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
                            <div className="absolute top-1/8 left-1/2 -z-10 bg-gradient-to-r from-green-200 to-green-600 w-1/2 lg:w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[4rem] lg:blur-[10rem] animate-image-glow"></div>
